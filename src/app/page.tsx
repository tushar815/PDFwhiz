...
export default function Home() {
  return (
    ...
    <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
      ...
      justify-center space-x-2 overflow-hidden rounded-full border border-gray-200 bg-white px-7 py-2 
      shadow-md backdrop-blur transition-all hover:border-gray-300 hover:bg-white/50"
      >
        <p className="text-sm font-semibold text-gray-700">
          PDFWhiz is now available for public acesss!!!
        </p>
      </div>
      ...
      <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
        PDFWhiz allows you to have conversations with PDF document. Simply upload your file and 
    ...
    <div>
      <div className="relative isolate">
        {/* hide it for disabled people by using aria hidden */}
        <div aria-hidden='true' className="pointer-events-none absolute inset-x-0 -top-40 -z-10 transform-gpu overflow-hidden blur-3xl 
        sm:-top-80">
            <div style={{
    ...
    <div className="mx-auto mb-32 mt-32  max-w-5xl sm:mt-56">
            <div className="mb-12 px-6 lg:px-8">
              <div className="mx-auto max-w-2xl sm:text-center">
                  ...
                  <p className="mt-4 text-lg text-gray-600 ">
                    Chatting with your pdf has never been easier than with PDFwhiz.
                  </p>
              </div>
            </div>
            {/* steps */}
            <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0 ">
              <li className="md:flex-1">
                ...
                md:border-l-0 md:border-t-2 md:pb-0 md:pd-0 md:pt-4">
                  <span className="text-sm font-medium text-red-600">Step 1</span>
                  <span className="text-xl font-semibold">Sign for an account</span>
                  <span className="mt-2 text-zinc-700">Either starting with free 
                    plan or choose our <Link href="/pricing" className="text-red-700 underline underline-offset-2">pro plan</Link></span>
              ...
              <li className="md:flex-1">
                ...
                md:border-l-0 md:border-t-2 md:pb-0 md:pd-0 md:pt-4">
                  ...
                  <span className="mt-2 text-zinc-700">
                    It&apos;s that simple. Try out the PDFWhiz today - it really takes less than any minute.
                    </span> 
                </div>
              </li>
            </ol>
